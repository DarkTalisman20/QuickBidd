...
public class CartController {
	...
	public ResponseEntity helloWorldmethod() {
	  	
		System.out.println("REQUEST CAME FOR ART GALLERY");
		
		System.out.println("Response SENT["+"HELLO MURAD, HOW ARE YOU?"+"]");
		
		return new ResponseEntity("HELLO MURAD, HOW ARE YOU?", HttpStatus.OK);
